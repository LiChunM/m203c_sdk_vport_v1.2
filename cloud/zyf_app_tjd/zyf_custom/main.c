 ...
 *   Compile & Run:
 *
 *     Set "C_PREDEF=-D __ZFY_JT_APP__; CLOUD_SOLUTION =ZYF_JT_SOLUTION " in gcc_makefile file. And compile the 
				...
				if(init==0)
					{
						...
						BB_OFF;
						SPK_AMP_EN_OFF;
						M203C_send_Epocmd("AT+QGNSSC=0",1<<7,50);
						Ql_Sleep(50);
						Ql_SleepEnable(); 
					}
				Ql_Sleep(50000);
