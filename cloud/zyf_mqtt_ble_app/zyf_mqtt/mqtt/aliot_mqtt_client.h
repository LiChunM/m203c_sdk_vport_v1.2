...
#define AMC_SUB_NUM_MAX (4)

/* maximum republish elements in list */
#define AMC_REPUB_NUM_MAX (5)
...
typedef struct {
    ...
    char*                 client_id;              /* Specify MQTT connection client id*/
    char*                 user_name;              /* Specify MQTT user name */
    char*                 password;               /* Specify MQTT password */
