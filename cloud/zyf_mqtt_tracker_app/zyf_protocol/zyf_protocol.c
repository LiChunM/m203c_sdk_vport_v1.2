...
*22BC:传输间隔
*
*AutomaticRD[READONLYNUM]={"1792","087B","1480","00EA","1E9D","023A","2557"};
*
*
*/
...
s32 zyf_decode_cmd(char *Payload,u16 len)
{
	...
	if(ret==0)
		{
			...
			if(p!=NULL)
				{
					zyf_protocol_info("workmode 1");
				}
			else 
				{
					zyf_protocol_info("workmode 0");
				}
		}
	...
	if(ret==0)
		{
			u8 *p=NULL;
			p=Ql_strstr(value[2],"0");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 0");
					setmcu2clk(1000);
				}
			p=Ql_strstr(value[2],"1");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 1");
					setmcu2clk(25);
				}
			p=Ql_strstr(value[2],"2");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 2");
					setmcu2clk(20);
				}
			p=Ql_strstr(value[2],"3");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 3");
					setmcu2clk(15);
				}
			p=Ql_strstr(value[2],"4");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 4");
					setmcu2clk(10);
				}
			p=Ql_strstr(value[2],"5");
			if(p!=NULL)
				{
					zyf_protocol_info("clk 5");
					setmcu2clk(5);
				}
			
		}
	
	ret=Ql_strcmp(value[0], AutomaticWR[2]);
	if(ret==0)
		{
			u8 *p=NULL;
			p=Ql_strstr(value[2],"1");
	...
	ret=Ql_strcmp(value[0], AutomaticWR[3]);
	if(ret==0)
		{
