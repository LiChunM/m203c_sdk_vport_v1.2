...
typedef enum IOT_RETURN_CODES {
    ...
    ERROR_AUTH_DATA_LENGTH,
    ERROR_AUTH_MEM_ALLOC,
    ERROR_AUTH_GENERATE_DATA,
    ERROR_AUTH_HTTP_POST,
    ERROR_AUTH_JSON_PARSE,
    ERROR_AUTH_GENERATE_CLIENT_ID,
...
#define ALIOT_FUNC_ENTRY    \
    {\
        aliot_platform_printf("FUNC_ENTRY:   %s L#%d \n", __PRETTY_FUNCTION__, __LINE__);  \
    }
#define ALIOT_FUNC_EXIT    \
    {\
        aliot_platform_printf("FUNC_EXIT:   %s L#%d \n", __PRETTY_FUNCTION__, __LINE__);  \
    }
#define ALIOT_FUNC_EXIT_RC(x)    \
    {\
        aliot_platform_printf("FUNC_EXIT:   %s L#%d Return Code : %d \n", __PRETTY_FUNCTION__, __LINE__, x);  \
        return x; \
    }
#else
