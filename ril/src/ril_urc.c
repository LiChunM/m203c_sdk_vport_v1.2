...
#ifdef __ZFY_MQTT_APP__
extern void OnURCHandler_BLEScan(const char* strURC, void* reserved);
#endif
...
#ifdef __ZFY_MQTT_APP__
    {"\r\n+QBTGATCSCAN:",                          OnURCHandler_BLEScan},
#endif
...
#ifdef __OCPU_RIL_SSL_SUPPORT__
	{"\r\n+QSSLURC:",                             OnURCHandler_QSSLURC},
    {"\r\n+QSECWRITE:",                             OnURCHandler_QSECWRITE},
    {"\r\n+QSSLOPEN:",                             OnURCHandler_QSSLOPEN},
    {"\r\nSEND",                             OnURCHandler_QISEND},
#endif
